<?php
	...
	$cabeceras = "From: $email\n" //La persona que envia el correo
 		. "Reply-To: $email\n"
 		."Bcc: jesushfloresn@gmail.com";
	$asunto = "Mensaje desde la página Web 'A3 Arquitectos'"; 
	//asunto aparecera en la bandeja del servidor de correo
	$email_to = "contacto@areatres.com.mx"; //cambiar por tu email
	$contenido = "$nombre ha enviado un mensaje desde la página web -A3 Arquitectos-\n"
	. "\n"
	. "Nombre: $nombre\n"
	. "Teléfono: $telefono\n"
	. "Email: $email\n"
